(function() {
  ...
  print = function(report, value, hover, line, comment, color, linenum, unpatched) {
    var long;
    if (linenum == null) {
      linenum = 0;
    }
  ...
  dispatch = function(state, done) {
    var apply, args, attach, change, color, comment, count, err, hover, input, label, line, list, local, lookup, output, patch, polynomial, previous, result, s, show, units, unpatched, v, value, _ref, _ref1;
  ...
  emit = function(div, item, done) {
    var candidates, elem, input, output, refresh, scrub, state, _i, _len, _ref, _ref1;
    input = {};
    output = {};
    refresh = function(state) {
      var $show, each, label, table, text, value, _i, _len, _ref, _ref1, _ref2, _results, _results1;
      if (state.show) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          each = _ref[_i];
          _results.push($show.append($("<p class=readout>" + each.readout + "</p>\n<p class=legend>" + each.legend + "</p>")));
        }
        return _results;
      } else {
        ...
        if (output['debug']) {
          ...
          for (label in _ref2) {
            value = _ref2[label];
            _results1.push(state.div.append($("<p class=error>" + label + " =><br> " + (inspect(value)) + "</p>")));
          }
          return _results1;
        }
      }
    };
    scrub = function(e, $td, $b) {
    ...
    for (_i = 0, _len = candidates.length; _i < _len; _i++) {
      ...
      if (elem.hasClass('radar-source')) {
        ...
        _.extend(input, (_ref = elem.data('item')) != null ? (_ref1 = _ref.data) != null ? _ref1[0] : void 0 : void 0);
      }
    }
